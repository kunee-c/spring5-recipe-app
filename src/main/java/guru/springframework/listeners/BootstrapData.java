...
public class BootstrapData {
    ...
    public void initData(ContextRefreshedEvent contextStartedEvent) {
        ...
        avocados.setUom(unitOfMeasureRepository.findByDescription("Ounce").get());

        guacamole.getIngredients().add(avocados);
        Category mex = categoryRepository.findByDescription("Mexican").get();
        mex.getRecipes().add(guacamole);
